...
/* package qcheck-0.1.0.0 */
#ifndef VERSION_qcheck
#define VERSION_qcheck "0.1.0.0"
#endif /* VERSION_qcheck */
#ifndef MIN_VERSION_qcheck
#define MIN_VERSION_qcheck(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_qcheck */
...
#define CURRENT_COMPONENT_ID "qcheck-0.1.0.0-inplace-qcheck-test"
